...
def autocorrect(word, trie: Trie):
    ...
    if best_match and cosine_similarity(word_normalized, normalize_text(best_match)) < COSINE_SIMILARITY_THRESHOLD:
        return ("null", "")
