    ...
    try:
        ...
        if debug and ok < 3:
            ...
            if province_correct == 0:
                print(f"Province -> Actual: '{result['province']}', Expected: '{answer['province']}'")
            if district_correct == 0:
                print(f"District -> Actual: '{result['district']}', Expected: '{answer['district']}'")
            if ward_correct == 0:
                print(f"Ward -> Actual: '{result['ward']}', Expected: '{answer['ward']}'")
